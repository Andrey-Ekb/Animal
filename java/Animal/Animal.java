...
public class Animal {
    ...
    public static Type Horse;
    public static Type Camel;
    public static Type Donkey;
    ...
    protected Animal(String name, LocalDate birthday, Type type) {
        this.name = name;
    ...
    protected Animal(String name, LocalDate birthday, Set<String> commands, Type type) {
        this.name = name;
        this.birthday = birthday;
